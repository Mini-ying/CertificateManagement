...
parser.add_argument('session_id',type=str,required=True,help='必须传入届次id',location='form')
...
delete_parser.add_argument('certificate_id',type=str,required=True,help='必须填写要删除的certificate_id')
